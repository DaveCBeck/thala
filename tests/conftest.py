...
# Re-export fixtures from tests/fixtures/ for pytest discovery
...
def logging_run(request: pytest.FixtureRequest) -> Generator[None, None, None]:
    ...
    # Use test module path as run identifier (e.g., "test-tests-test_fixtures")
    test_path = request.node.nodeid.split("::")[0]  # e.g., "tests/test_fixtures.py"
