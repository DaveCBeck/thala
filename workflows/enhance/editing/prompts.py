...
- Add citations where arguments would benefit
...
- Add [@KEY] citations where claims need supporting evidence

Use the available tools to:
1. Search for papers supporting key claims
2. Add citations where they strengthen the argument
3. Verify existing citations are accurate

Output the COMPLETE enhanced content with added citations in [@KEY] format.
...
- Use [@KEY] format for citations (8 alphanumeric characters)
- Maintain academic tone
- Do not invent citations - only use papers found via search
...
- Stay within ±{tolerance_percent}% of original word count
- Add [@KEY] citations where claims need supporting evidence
- Only use citation keys found via the search_papers tool
...
# =============================================================================
# Phase 7: Verify Facts (when document has citations)
# =============================================================================

# Pre-screening prompts for fact-check phase
