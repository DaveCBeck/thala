...
QUALITY_PRESETS: dict[QualityTier, BookFindingQualitySettings] = {
    "test": BookFindingQualitySettings(
        recommendations_per_category=1,
    ...
    "high_quality": BookFindingQualitySettings(
        recommendations_per_category=7,
        max_concurrent_downloads=7,
        max_content_for_summary=150000,
        recommendation_max_tokens=8192,
