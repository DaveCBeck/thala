...
# Base directory for workflow test scripts
WORKFLOW_TESTS_DIR = Path(__file__).parent.parent
...
def get_log_dir() -> Path:
    ...
    """
    log_dir = WORKFLOW_TESTS_DIR.parent.parent / "logs"
...
def get_output_dir(subdir: str = "test_data") -> Path:
    ...
    Args:
        subdir: Subdirectory name under scripts/workflow_tests/

    Returns:
        Path to output directory
    """
    output_dir = WORKFLOW_TESTS_DIR / subdir
